...
import com.lisn.demo.core.constant.MailConstant;
import com.lisn.demo.core.utils.UploadActionUtil;
import com.lisn.demo.model.Mail;
import com.lisn.demo.service.MailService;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendInlineMail(Mail mail){
        try{
            ...
            helper.setTo(mail.getTo());
            helper.setSubject(mail.getSubject());
            helper.setText("<html><body><img src=\"cid:SG\" ></body></html>", true);

            FileSystemResource file = new FileSystemResource(new File("C:\\Users\\Administrator\\Desktop\\设计图\\微信图片_20180323135358.png"));
            // addInline函数中资源名称chuchen需要与正文中cid:chuchen对应起来
            helper.addInline("SG", file);
            mailSender.send(mimeMessage);
        }catch (Exception e){
