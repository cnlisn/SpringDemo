...
import com.lisn.demo.core.constant.ProjectConstant;
...
public class CodeGenerator {
    ...
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/SGDB";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "ls123456";
    ...
    // @author
    private static final String AUTHOR = "SG";
    // @date
